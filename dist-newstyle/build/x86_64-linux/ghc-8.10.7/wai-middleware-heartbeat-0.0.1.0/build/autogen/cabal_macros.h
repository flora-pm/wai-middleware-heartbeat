...
/* package wai-middleware-heartbeat-0.0.1.0 */
#ifndef VERSION_wai_middleware_heartbeat
#define VERSION_wai_middleware_heartbeat "0.0.1.0"
#endif /* VERSION_wai_middleware_heartbeat */
#ifndef MIN_VERSION_wai_middleware_heartbeat
#define MIN_VERSION_wai_middleware_heartbeat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 1)
#endif /* MIN_VERSION_wai_middleware_heartbeat */
...
#define CURRENT_PACKAGE_KEY "wai-middleware-heartbeat-0.0.1.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "wai-middleware-heartbeat-0.0.1.0-inplace"
